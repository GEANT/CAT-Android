...
public class StatusFragment extends Fragment implements OnClickListener {
    ...
    public String latestSummary()
    {
        ...
        String linkSpeed=eduroamCAT.wifiCon.getLinkSpeed()+" Mbps";
        ...
        summaryText+="SSID: <b><font color=\"blue\">"+currentSSID+"</font></b> - BSSID: <b>"+bSSID+"</b><br/>";
		summaryText+="Signal Strength: <b>"+rss+"dBm</b> - Link Speed: <b>"+linkSpeed+"</b><br/>";
